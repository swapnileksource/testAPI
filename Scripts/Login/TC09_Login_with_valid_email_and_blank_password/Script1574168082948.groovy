...
if (login_status_code == 400){
    ...
    WS.verifyElementPropertyValue(response, 'ValidationErrors[0].Name', 'Password', FailureHandling.CONTINUE_ON_FAILURE)

    WS.verifyElementPropertyValue(response, 'ValidationErrors[0].Description', 'Password is required.', FailureHandling.CONTINUE_ON_FAILURE)
