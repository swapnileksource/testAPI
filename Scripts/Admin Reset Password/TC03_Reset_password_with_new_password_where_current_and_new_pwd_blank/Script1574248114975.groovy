...
if (login_status_code == 200) {
    ...
    if (AdminResetPassword_statusCode == 400) {
		
        KeywordUtil.markPassed('NewPassword & CurrentPassword fields are blank')
		
    } else {
	
        KeywordUtil.markFailed("AdminResetPassword:Expected status code is '400' but actual status code is "+AdminResetPassword_statusCode)
